...
public class GerenciarLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().getAttribute("ulogado");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(erros.size()>0){
            ...
            exibirMensagem("Preencha o(s) campos(s):"+campos);
            ...
            try{
                ...
                if(u.getIdUsuario()>0 && u.getSenha().equals(senha) && u.getStatus()==1 && u.getPerfil().getStatus()==1){
